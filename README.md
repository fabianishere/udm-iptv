...
|      Tweak (NL) |    4     | 0.0.0.0/0                                                             | Use default DHCP options (`-O staticroutes -V IPTV_RG`) and use different MACADDRES on iptv interface (IPTV_WAN_VLAN_MAC="xx:xx:xx:xx:xx:xx") |
